# Referência de Hooks {#chap-hooks}

Nixpkgs possui vários pacotes de hooks que aumentam as fases do stdenv.

Os hooks embutidos do stdenv estão documentados em [](#ssec-setup-hooks).
